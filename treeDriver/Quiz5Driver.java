 ...
 * @version (Mar 2019)
 */
public class Quiz5Driver {
	public static void main(String args[]) {
		System.out.println("\n\nTesting problem 2");
		Expr e1 = new Quotient(new Constant(100), new Constant(50)); // 100/50
		Expr e2 = new Quotient(new Constant(100), new Constant(25)); // 100/25
		e1 = new Quotient(e1, e2);
		System.out.println("The quotient is " + e1); // ((100/50)/(100/25))
		System.out.println("It simplifies to " + e1.simplify()); // 0
...
//		ok = false;
//
//		e1 = new Sum(new Assign(a, new Constant(5)), new Assign(b, new Constant(7))); // e1 = (a=5) + (b=7)
//		try {
//			System.out.println(new Sum(a, b).eval());
//		} catch (IllegalArgumentException iae) {
//			ok = true;
